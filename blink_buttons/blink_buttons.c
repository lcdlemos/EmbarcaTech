// Retirado de https://github.com/BitDogLab/BitDogLab-C/blob/main/button_led_rgb/button_led_rgb.c
#include <stdio.h>
...
int main() {
    ...
    while (true) {
        // Se ambos forem pressionados
        if (gpio_get(BUTTON_B_PIN) == 0 && gpio_get(BUTTON_A_PIN) == 0) {
        ...
        // Se o botão A for pressionado
            ...
            gpio_put(RED_LED_PIN, 0);   // Desiga o LED vermelho
            gpio_put(GREEN_LED_PIN, 0);  // Desliga o LED verde
        }
